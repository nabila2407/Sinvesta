                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input 
                                    ...
                                    id="status_baik" 
                                    value="Baik" 
                                    {{ old('status_barang', $barang->status_barang) == 'Baik' ? 'checked' : '' }}
                                >
                            ...
                            <div class="form-check form-check-inline">
                                <input 
                                    ...
                                    value="Rusak Ringan" 
                                    {{ old('status_barang', $barang->status_barang) == 'Rusak Ringan' ? 'checked' : '' }}
                                >
                            ...
                            <div class="form-check form-check-inline">
                                <input 
                                    ...
                                    value="Rusak Berat" 
                                    {{ old('status_barang', $barang->status_barang) == 'Rusak Berat' ? 'checked' : '' }}
                                >
                            ...
                            <div class="form-check form-check-inline">
                                <input 
                                    ...
                                    id="status_hilang" 
                                    value="Hilang" 
                                    {{ old('status_barang', $barang->status_barang) == 'Hilang' ? 'checked' : '' }}
                                >
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea 
                                ...
                                id="deskripsi" 
                                name="deskripsi">{{ old('deskripsi', $barang->deskripsi) }}</textarea>
